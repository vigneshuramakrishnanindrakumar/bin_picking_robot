...
{
  new (message_memory) interfaces::msg::DoorState(_init);
}

void DoorState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::DoorState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DoorState_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::msg::DoorState, is_closed),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DoorState_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::msg::DoorState),
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::DoorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, DoorState)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::DoorState_message_type_support_handle;
}
