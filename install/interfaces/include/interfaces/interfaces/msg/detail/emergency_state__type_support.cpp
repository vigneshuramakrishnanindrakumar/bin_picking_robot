...
{
  new (message_memory) interfaces::msg::EmergencyState(_init);
}

void EmergencyState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::EmergencyState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencyState_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::msg::EmergencyState, is_pressed),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencyState_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::msg::EmergencyState),
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::EmergencyState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, EmergencyState)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::EmergencyState_message_type_support_handle;
}
