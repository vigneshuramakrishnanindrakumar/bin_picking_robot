...
#include "interfaces/msg/detail/emergency_state__rosidl_typesupport_fastrtps_c.h"
...
using _EmergencyState__ros_msg_type = interfaces__msg__EmergencyState;
...
size_t get_serialized_size_interfaces__msg__EmergencyState(
  const void * untyped_ros_message,
...
static uint32_t _EmergencyState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__EmergencyState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__EmergencyState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__EmergencyState;
    is_plain =
      (
...
static size_t _EmergencyState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__EmergencyState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, EmergencyState)() {
