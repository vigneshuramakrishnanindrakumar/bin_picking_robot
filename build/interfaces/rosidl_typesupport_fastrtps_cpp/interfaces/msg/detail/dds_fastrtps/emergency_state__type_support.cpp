...
#include "interfaces/msg/detail/emergency_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::EmergencyState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::EmergencyState & ros_message)
{
  // Member: is_pressed
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::EmergencyState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::EmergencyState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::EmergencyState *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_EmergencyState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, EmergencyState)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_EmergencyState__handle;
}
